...
public class GG : EnemyManager
{
    ...
    public void SetBackHit()
    {
        ...
        if (Command.Back_Obj.name == "Character_D")
        {
            Dealler.bHit = true;
        ...
        else if (Command.Back_Obj.name == "Character_T")
        {
            Tanker.bHit = true;
        ...
        else if (Command.Back_Obj.name == "Character_S")
        {
            Supporter.bHit = true;
